...
public class LoginForma extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        ArrayList<Korisnik> lista = (ArrayList<Korisnik>) Komunikacija.getInstance().primiOdgovor().getOdgovor();
        for (Korisnik korisnik : lista) {
            if(username.equals(korisnik.getUsername()) && password.equals(korisnik.getPassword())){
        ...
        JOptionPane.showMessageDialog(this, "Nema takvog korisnika");
