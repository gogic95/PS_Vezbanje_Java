...
public class ServerskaForma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnObrisi.setText("Ponisti ugovor");
    ...
    private void btnObrisiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnObrisiActionPerformed
        ...
        Ugovor u = lista.get(tblUgovori.getSelectedRow());
        
        Kontrolor.getInstance().obrisiUgovor(u);
        mtu.obrisiIzTabele(tblUgovori.getSelectedRow());
    ...
    public void srediTabelu() {
        ...
        ArrayList<Ugovor> listaUgovora = Kontrolor.getInstance().vratiUgovore();
        
        mtu.setListaUgovora(listaUgovora);
    }
}
